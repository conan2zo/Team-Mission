...
public class JEMMemberDTO {
    ...
    public JEMMemberDTO(String EMP_ID, String EMP_NAME, String ENP_NO, String EMAIL, String PHONE, String DEPT_CODE, String JOB_CODE, String SAL_LEVEL, int SALARY, Double BONUS, String MANAGER_ID, Date HIRE_DATE, Date ENT_DATE, String ENT_YN) {
        this.EMP_ID = EMP_ID;
